...
function App() {
  return (
    ...
    <div className="min-h-screen">
      ...
      <nav className="bg-gray-800 h-16 sticky top-0">
            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <Link to={'comments'} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">comments</Link>
                  <Link to={'albums'} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">albums</Link>
                  <Link to={'photos'} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">photos</Link>
                  <Link to={'todos'} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">todos</Link>
